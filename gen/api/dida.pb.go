...
type Task struct {
	...
	SortOrder     int64            `protobuf:"varint,15,opt,name=sort_order,json=sortOrder,proto3" json:"sort_order,omitempty"`
...
func (x *Task) GetSortOrder() int64 {
	if x != nil {
		return x.SortOrder
	}
	return 0
...
var file_api_dida_proto_rawDesc = string([]byte{
	...
	0x0f, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x73, 0x6f, 0x72, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72,
